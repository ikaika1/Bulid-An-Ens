const main = async () => {
  ...
  const domainContract = await domainContractFactory.deploy("ika");
  await domainContract.deployed();

  console.log("Contract deployed to:", domainContract.address);
  const domainName = "sol";
  ...
  await txn.wait();
  console.log(`Minted domain ${domainName}.ika`);

  txn = await domainContract.setRecord(domainName, "Am I a banana or a ika??");
  await txn.wait();
  console.log("Set record for banana.ika");
